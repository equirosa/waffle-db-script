...
CREATE PROCEDURE UPD_CADENA_PR
	...
	@LOGO VARCHAR(100)
AS
	UPDATE CADENA SET ID=@ID,CEDULA_DUENNIO=@CEDULA_DUENNIO,LOGO=@LOGO;
GO
...
CREATE PROCEDURE UPD_COMERCIO_PR
	...
	@SUPERVISOR VARCHAR(50)
AS
	UPDATE COMERCIO SET CEDULA_JURIDICA=@CEDULA_JURIDICA,CEDULA_DUENO=@CEDULA_DUENO,ID_DIRECCION=@ID_DIRECCION,ID_CATEGORIA=@ID_CATEGORIA,
		...
		NOMBRE_COMERCIAL=@NOMBRE_COMERCIAL,FECHA_CREACION=@FECHA_CREACION,WEB=@WEB,ESTADO=@ESTADO,SUPERVISOR=@SUPERVISOR;
GO
