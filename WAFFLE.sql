...
AS
	UPDATE USUARIO SET NOMBRE=@NOMBRE,APELLIDO1=@APELLIDO1,APELLIDO2=@APELLIDO2,
		CORREO=@CORREO,CONTRASENNA=@CONTRASENNA,TEL=@TEL,PAYPAL=@PAYPAL,
		ESTADO=@ESTADO,TIPO_IDENTIFICACION=@TIPO_IDENTIFICACION,CODIGO_VERIFICACION=@CODIGO_VERIFICACION);
GO
